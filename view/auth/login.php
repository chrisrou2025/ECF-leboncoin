<?php
/**
 * ControllerUser - Gère les opérations liées aux utilisateurs
 */
?>
<!DOCTYPE html>
<html lang="fr">
...
<head>
    ...
    <title>Connexion - labonnetrouvaille</title>
    ...
    <main class="main-container">
        <div class="form-container">
            <div class="form-content">
                <!-- Titre principal -->
                <h1 class="form-title">
                    Connectez-vous à votre<br>compte labonnetrouvaille
                </h1>
                ...
                <div class="form-section">
                    ...
                    <form method="POST" action="/ECF-leboncoin/login">
                        <!-- Champ Email -->
            ...
            <div class="image-section">
                <img src="/ECF-leboncoin/asset/images/image.png"
                    alt="Connexion labonnetrouvaille"
